...
import pl.rstanski.adventofcode2022.day19.part2.RobotType.CLAY
import pl.rstanski.adventofcode2022.day19.part2.RobotType.GEODE
import pl.rstanski.adventofcode2022.day19.part2.RobotType.OBSIDIAN
import pl.rstanski.adventofcode2022.day19.part2.RobotType.ORE

fun main() {
//    val testSolution = solvePart2(load("day19sample.txt"))
...
private fun solvePart2(puzzle: Puzzle): Any {
    ...
    val minedGeode = blueprints.take(3).map { blueprint ->
        val geode = mineWithBlueprint(blueprint)

        blueprint.index to geode
    }

    minedGeode.forEach { println("mined geode: $it") }

    return minedGeode.map {it.second.toLong() }.reduce {acc: Long, l: Long -> acc * l }
}


class MineSession(private val blueprint: Blueprint, private val minutesLimit: Int) {
...
fun mineWithBlueprint(blueprint: Blueprint): Int {
    ...
    val mineSession = MineSession(blueprint, 32)
